package io.github.import1024.youkong.common.utils.logger;
...
import io.github.import1024.youkong.common.utils.logger.util.ArrayUtil;
import io.github.import1024.youkong.common.utils.logger.util.SystemUtil;
 ...
 * @author Orhan Obut
 */
final class LoggerPrinter implements io.github.import1024.youkong.common.utils.logger.Printer {
   ...
   */
  private static final io.github.import1024.youkong.common.utils.logger.Settings settings = new io.github.import1024.youkong.common.utils.logger.Settings();
   ...
   */
  @Override
  public io.github.import1024.youkong.common.utils.logger.Settings init(String tag) {
    if (tag == null) {
  ...
  @Override
  public io.github.import1024.youkong.common.utils.logger.Settings getSettings() {
    return settings;
  }
